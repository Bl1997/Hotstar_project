...
const InternetSuperStarSlider = () => {
    ...
    useEffect(() => {
      axios
        .get(
          ` https://www.googleapis.com/youtube/v3/search?q= internet super star  &key=${API_KEY}&part=snippet&maxResults=50&order=title`
        )
...
export default InternetSuperStarSlider;
